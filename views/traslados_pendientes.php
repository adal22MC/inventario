...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h2 class="badge badge-primary">Traslados Pendientes</h2>
                            </div>
                            <div class="card-header">
                                <div class="input-group pt-3">
                                    ...
                                    <select class="form-control" name="categoria" id="selectSolicitud">
                                        <option value="default" >Seleccione un número de traslado</option>
                                    </select>
                                </div>
                            </div>
                            <!-- /.card-header -->
    ...
    <script src="dist/js/pages/traslados_pendientes.js"></script>
</body>
