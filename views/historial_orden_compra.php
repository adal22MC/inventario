...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h2 class="badge badge-primary">Historial Orden Compra</h2>
                            </div>
                            <div class="card-header">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="h_orden" class="table table-bordered table-striped tablaModulos">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Fecha</th>
    ...
    <script src="dist/js/pages/historial_orden_compra.js"></script>
</body>
