                    ...
                    <form id="formAddBodega">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="input-group pt-3">
                                ...
                                <input type="text" class="form-control" name="userBodega" placeholder="Username">
                            </div>
                            ...
                            <div class="input-group pt-3">
                                ...
                                <input type="password" class="form-control" name="passBodega" placeholder="Contraseña">
                            </div>
                    ...
                    <form id="formEditBodega">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="input-group pt-3">
                                ...
                                <input type="text" class="form-control" id="userBodega" name="userBodega" placeholder="Username">
                            </div>
                            ...
                            <div class="input-group pt-3">
                                ...
                                <input type="text" class="form-control" id="passBodega" name="passBodega" placeholder="Contraseña">
                            </div>
